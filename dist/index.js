...
var SubMenu = function (_a, ref) {
    ...
    return (React__default["default"].createElement("li", __assign({ ref: subMenuRef, className: classnames('pro-menu-item pro-sub-menu', className, {
        ...
        firstchild && collapsed ? (React__default["default"].createElement("span", null)) : (React__default["default"].createElement(SlideDown, { closed: typeof open === 'undefined' ? closed : !open, className: "pro-inner-list-item" },
