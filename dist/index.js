...
var ProSidebar = function (_a, ref) {
    ...
    var sidebarRef = ref || React__default["default"].createRef();
    ...
    return (React__default["default"].createElement(SidebarContext.Provider, { value: sidebarState },
        React__default["default"].createElement("div", __assign({ ref: sidebarRef, className: classnames('pro-sidebar', className, breakPoint, { collapsed: collapsed, rtl: rtl, toggled: toggled }), style: __assign(__assign({}, finalWidth), style) }, rest),
            React__default["default"].createElement("div", { className: "pro-sidebar-inner" },
                image ? React__default["default"].createElement("img", { src: image, alt: "sidebar background", className: "sidebar-bg" }) : null,
                React__default["default"].createElement("div", { className: "pro-sidebar-layout" }, children)),
            React__default["default"].createElement("div", { className: "overlay", onClick: handleToggleSidebar, onKeyPress: handleToggleSidebar, role: "button", tabIndex: 0, "aria-label": "overlay" }))));
};
var ProSidebar$1 = React.forwardRef(ProSidebar);

var SidebarHeader = function (_a, ref) {
    var children = _a.children, className = _a.className, rest = __rest(_a, ["children", "className"]);
    var sidebarHeaderRef = ref || React__default["default"].createRef();
    return (React__default["default"].createElement("div", __assign({ ref: sidebarHeaderRef, className: classnames('pro-sidebar-header', className) }, rest), children));
};
var SidebarHeader$1 = React.forwardRef(SidebarHeader);

var SidebarContent = function (_a, ref) {
    var children = _a.children, className = _a.className, rest = __rest(_a, ["children", "className"]);
    var sidebarContentRef = ref || React__default["default"].createRef();
    return (React__default["default"].createElement("div", __assign({ ref: sidebarContentRef, className: classnames('pro-sidebar-content', className) }, rest), children));
};
var SidebarContent$1 = React.forwardRef(SidebarContent);

var SidebarFooter = function (_a, ref) {
    var children = _a.children, className = _a.className, rest = __rest(_a, ["children", "className"]);
    var sidebarFooterRef = ref || React__default["default"].createRef();
    return (React__default["default"].createElement("div", __assign({ ref: sidebarFooterRef, className: classnames('pro-sidebar-footer', className) }, rest), children));
};
...
var Menu = function (_a, ref) {
    ...
    var menuRef = ref || React__default["default"].createRef();
    return (React__default["default"].createElement("nav", __assign({ ref: menuRef, className: classnames('pro-menu', className, (_b = {},
            ...
            _b)) }, rest),
        React__default["default"].createElement("ul", null, React__default["default"].Children.toArray(children)
            .filter(Boolean)
...
var MenuItem = function (_a, ref) {
    ...
    var menuItemRef = ref || React__default["default"].createRef();
    return (React__default["default"].createElement("li", __assign({ ref: menuItemRef, className: classnames('pro-menu-item', className, { active: active }) }, rest),
        React__default["default"].createElement("div", { className: "pro-inner-item", tabIndex: 0, role: "button" },
            icon ? (React__default["default"].createElement("span", { className: "pro-icon-wrapper" },
                React__default["default"].createElement("span", { className: "pro-icon" }, icon))) : null,
            prefix ? React__default["default"].createElement("span", { className: "prefix-wrapper" }, prefix) : null,
            React__default["default"].createElement("span", { className: "pro-item-content" }, children),
            suffix ? React__default["default"].createElement("span", { className: "suffix-wrapper" }, suffix) : null)));
};
...
var react_1 = tslib_es6.__importStar(React__default["default"]);
...
var SubMenu = function (_a, ref) {
    var children = _a.children, icon = _a.icon, className = _a.className, title = _a.title, _b = _a.defaultOpen, defaultOpen = _b === void 0 ? false : _b; _a.open; var prefix = _a.prefix, suffix = _a.suffix, firstchild = _a.firstchild; _a.popperarrow; var onOpenChange = _a.onOpenChange, rest = __rest(_a, ["children", "icon", "className", "title", "defaultOpen", "open", "prefix", "suffix", "firstchild", "popperarrow", "onOpenChange"]);
    var popperInstance;
    ...
    var subMenuRef = ref || React__default["default"].createRef();
    return (React__default["default"].createElement("li", __assign({ ref: subMenuRef, className: classnames('pro-menu-item pro-sub-menu', className, {
            open: true,
        }) }, rest),
        React__default["default"].createElement("div", { ref: referenceElement, className: "pro-inner-item", onClick: handleToggleSubMenu, onKeyPress: handleToggleSubMenu, role: "button", tabIndex: 0 },
            icon ? (React__default["default"].createElement("span", { className: "pro-icon-wrapper" },
                React__default["default"].createElement("span", { className: "pro-icon" }, icon))) : null,
            prefix ? React__default["default"].createElement("span", { className: "prefix-wrapper" }, prefix) : null,
            React__default["default"].createElement("span", { className: "pro-item-content" }, title),
            suffix ? React__default["default"].createElement("span", { className: "suffix-wrapper" }, suffix) : null,
            React__default["default"].createElement("span", { className: "pro-arrow-wrapper" },
                React__default["default"].createElement("span", { className: "pro-arrow" }))),
        React__default["default"].createElement(SlideDown, { closed: false, className: "pro-inner-list-item" },
            React__default["default"].createElement("div", null,
                React__default["default"].createElement("ul", null, children)))));
};
