...
var SubMenu = function (_a, ref) {
    ...
    return (React.createElement("li", __assign({ ref: subMenuRef, className: classnames('pro-menu-item pro-sub-menu', className, {
        ...
        firstchild && collapsed ? (React.createElement("span", null)) : (React.createElement(SlideDown, { closed: typeof open === 'undefined' ? closed : !open, className: "pro-inner-list-item" },
